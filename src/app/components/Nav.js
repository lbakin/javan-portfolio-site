...
export default function Nav() {
  ...
  return (
    <div className="relative">
      ...
      {/* Menu */}
      <nav
        className={`fixed top-0 right-0 z-50 bg-gray-800 text-white transform transition-transform duration-300
      ...
      >
        <ul className="flex flex-col space-y-4">
          ...
          <li className="ml-4"><a href="/#portfolio3" className="text-xl" onClick={() => setIsOpen(false)}>Director</a></li>
